...
def operation(
    ...
    sensitivity =  stage_settings["sensitivity"]
    stiffness = stage_settings["stiffness"]
...
if __name__ == "__main__":
    ...
    setting_test = {
        ...
        "repeat_number": 1,
        "position_z": 0,
        "time_interval": 3,  # duration = time_interval / 2
    ...
    operation(
        ...
        # sample_name="AFM7_450_boundary_2",
        sample_name=f"AFM6_450_test_w5_4{'_return' if return_back else ''}",
